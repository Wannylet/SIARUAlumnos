...
function interfazAlumno(){
    ...
    $datosLicenciatura = extraerRegistroTabla("licenciatura", "idLicenciatura", $datosAlumno['fk_idLicenciatura']);
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td scope="row">Licenciatura</td>
                                            <td>
                                                <?php echo $datosLicenciatura['nombre'] . " (" . $datosLicenciatura['clave'] . ")"?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

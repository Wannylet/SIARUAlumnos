...
function interfazMaterias() {
    ...
    // Conexión a la base de datos y obtención de datos de materias
    ...
    $sql_materias = "SELECT m.nombre AS materia, m.clave AS clave, m.cargaHoraria AS horas_semana
                      FROM AlumnoMateria am
                      JOIN Materia m ON am.fk_idMateria = m.idMateria
                      WHERE am.fk_idAlumno = ?";
    ...
    <html lang="es">
        <head>
            ...
            <title>Materias del Curso Actual</title>
            <!-- Favicons -->
        ...
        <body>
            ...
            <aside id="sidebar" class="sidebar">
                <ul class="sidebar-nav" id="sidebar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link collapsed" href="calificaciones.php"><i class="bi bi-star"></i><span>Calificaciones</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="materias.php"><i class="bi bi-book"></i><span>Materias</span></a></li>
